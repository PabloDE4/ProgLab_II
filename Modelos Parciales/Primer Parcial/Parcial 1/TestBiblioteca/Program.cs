...
namespace DiazEcheveste.Pablo._2C
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Novela n1 = new Novela("Miseria", 63.88f, "Esteban", "Rey", EGenero.Romantica);
            Manual m2 = new Manual("C#", 29.95f, "Joe", "Mayo", ETipo.Tecnico);
            Novela n2 = new Novela("Miseria", 203.00f, "Esteban", "Rey", EGenero.Accion);
            Novela n3 = new Novela("Miseria", 98.00f, "Esteban", "Rey", EGenero.CienciaFiccion);
            Novela n4 = new Novela("Miseria", 103.50f, "Esteban", "Rey", EGenero.Accion);
