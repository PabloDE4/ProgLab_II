...
namespace Ejercicio5
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Creo 4 productos
            Producto p1 = new Producto("Pepsi", "PESDS97413", (float)12.5);
            Producto p2 = new Producto("Coca-Cola", "COSDS55752", (float)15.75);
            Producto p3 = new Producto("Manaos", "MASDS51292", (float)8.25);
